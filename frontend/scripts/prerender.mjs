...
const PAGES = [
  ...
  {
    path: '/kho-video', title: 'Kho video học ngoại ngữ · VyLing',
    desc: 'Kho video học ngoại ngữ đã kiểm chứng phụ đề: tiếng Hàn, tiếng Anh, Nhật, Trung, Đức, Việt — lọc theo trình độ và độ dài.',
    h1: 'Kho video học ngoại ngữ đã kiểm chứng phụ đề',
  ...
  {
    path: '/tieng-anh-3-thang', title: 'Tiếng Anh 3 tháng — lộ trình 90 ngày · VyLing',
    desc: 'Lộ trình tiếng Anh 90 ngày theo quy tắc 3C: 3000 từ tần suất cao, 18 bài ngữ pháp giao tiếp, 12 nhóm phát âm, tự tick theo tiến độ thật.',
    h1: 'Lộ trình học tiếng Anh 90 ngày',
    lead: 'Theo quy tắc 3C (Compress – Compile – Consolidate): học đúng từ cần học, ghép thành câu, rồi củng cố bằng ôn tập ngắt quãng.',
    points: [
      '3000 từ tần suất cao chia 117 chủ đề — đủ hiểu khoảng 90% hội thoại hằng ngày',
...
function build() {
  ...
  for (const page of PAGES) {
    ...
    const body = [
      ...
      '</ul>',
      '<nav><a href="/">Trang chủ</a> · <a href="/kho-video">Kho video</a> · ',
      '<a href="/tieng-han-3-thang">Tiếng Hàn 3 tháng</a> · <a href="/tieng-anh-3-thang">Tiếng Anh 3 tháng</a> · ',
