...
DEFAULT_EN_VIDEOS = [
    ...
    ("l29K-ZkARmE", "TED-Ed — Bi kịch của Cassandra, nàng công chúa tiên tri", "TED-Ed", "B2", "4:40", "Thần thoại", "tone-a", "en"),
    ("-61qDRPG3to", "TED-Ed — Cách lên máy bay nhanh nhất theo toán học", "TED-Ed", "B2", "5:57", "Khoa học", "tone-b", "en"),
    ("5jPCAlE0z7I", "TED-Ed — Khu rừng kỳ diệu dưới đáy đại dương", "TED-Ed", "B2", "5:51", "Thiên nhiên", "tone-c", "en"),
    ("JhxuP0AuRPA", "TED-Ed — Hộ chiếu có từ bao giờ?", "TED-Ed", "B2", "6:09", "Văn hoá", "tone-d", "en"),
    ("2A1IEBFt6Xg", "TED-Ed — Tàu đệm từ chạy bằng cách nào?", "TED-Ed", "B2", "6:27", "Khoa học", "tone-e", "en"),
    ("krNP8RlDsbw", "TED-Ed — Nhụy nghệ tây, loại gia vị đắt nhất thế giới", "TED-Ed", "B2", "6:41", "Ẩm thực", "tone-f", "en"),
    ("jFlzE6tg0S8", "Friends — Họ không biết là mình biết họ biết", "Friends", "B2", "2:13", "Hài hước", "tone-a", "en"),
    ("znh3FGMEd2M", "Friends — Monica và Chandler đưa mẹ nuôi đi đẻ", "Friends", "B2", "3:15", "Hài hước", "tone-b", "en"),
    ("Kvc8ttwBEnU", "Friends — Joey được rồi lại mất 1.500 đô", "Friends", "B2", "4:12", "Hài hước", "tone-c", "en"),
    ("Nq4M7vs9ins", "Friends — Vì sao Phoebe bị cấm hát cho trẻ con", "Friends", "B2", "4:41", "Hài hước", "tone-d", "en"),
    ("_LU9FnNwCFw", "Friends — Ross chưa từng đọc hết lá thư 18 trang", "Friends", "B2", "4:51", "Hài hước", "tone-e", "en"),
    ("Ys4Ex6yOXHA", "Friends — Nếu Ross và Rachel cưới người khác thì sao?", "Friends", "B2", "5:08", "Hài hước", "tone-f", "en"),
    ("151xrcfM_VY", "Young Sheldon — Chuyến đi hoá thành cuộc giải cứu", "Young Sheldon", "B2", "1:53", "Gia đình", "tone-a", "en"),
    ("Ra-J8nOd7-8", "Young Sheldon — Georgie dạy Missy cách kiếm lời", "Young Sheldon", "B2", "2:02", "Gia đình", "tone-b", "en"),
    ("A3jZR_4pfRA", "Young Sheldon — Lần đầu Missy trông trẻ", "Young Sheldon", "B2", "2:31", "Gia đình", "tone-c", "en"),
    ("wM5Mc8e33gQ", "Young Sheldon — Bữa tối náo loạn nhà Cooper", "Young Sheldon", "B2", "3:06", "Gia đình", "tone-d", "en"),
    ("1C3eU2Jy1k0", "Young Sheldon — Ai cũng mê bà ngoại Meemaw", "Young Sheldon", "B2", "3:13", "Gia đình", "tone-e", "en"),
    ("zUnEDRfx1k0", "Young Sheldon — Georgie thú nhận tuổi thật với Mandy", "Young Sheldon", "B2", "3:29", "Gia đình", "tone-f", "en"),
    ("nD7Xc6HD_Pk", "The Big Bang Theory — Penny ghen", "The Big Bang Theory", "B2", "1:34", "Hài hước", "tone-a", "en"),
    ("QjIRr5PL1rk", "The Big Bang Theory — Penny và Stuart hẹn hò", "The Big Bang Theory", "B2", "3:07", "Hài hước", "tone-b", "en"),
    ("uvLxVACwkFs", "The Big Bang Theory — Penny nợ tiền Sheldon", "The Big Bang Theory", "B2", "4:01", "Hài hước", "tone-c", "en"),
    ("no0HZ5eDdnY", "The Office — Màn Parkour công sở", "The Office", "B2", "2:35", "Công sở", "tone-a", "en"),
    ("BSV-twtKV_g", "The Office — Mở màn hỗn loạn nhất mọi thời", "The Office", "B2", "4:53", "Công sở", "tone-b", "en"),
    ("59bbhts01Q0", "Parks and Recreation — Cuộc thi làm burger của Ron và Chris", "Parks and Recreation", "B2", "5:16", "Công sở", "tone-c", "en"),
    ("oZn5LRn-giw", "Parks and Recreation — Mẹ Leslie đang tán tỉnh Ben?", "Parks and Recreation", "B2", "5:29", "Công sở", "tone-d", "en"),
]
