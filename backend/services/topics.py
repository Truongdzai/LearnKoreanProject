...
TAG_OVERRIDES = {
    "l29K-ZkARmE": ("story", "culture"),
    "-61qDRPG3to": ("science",),
    "5jPCAlE0z7I": ("science",),
    "JhxuP0AuRPA": ("culture",),
    "2A1IEBFt6Xg": ("science",),
    "krNP8RlDsbw": ("science", "food"),
    "jFlzE6tg0S8": ("comedy", "daily"),
    "znh3FGMEd2M": ("comedy", "daily"),
    "Kvc8ttwBEnU": ("comedy", "daily"),
    "Nq4M7vs9ins": ("comedy", "daily"),
    "_LU9FnNwCFw": ("comedy", "daily"),
    "Ys4Ex6yOXHA": ("comedy", "daily"),
    "151xrcfM_VY": ("comedy", "daily"),
    "Ra-J8nOd7-8": ("comedy", "daily"),
    "A3jZR_4pfRA": ("comedy", "daily"),
    "wM5Mc8e33gQ": ("comedy", "daily"),
    "1C3eU2Jy1k0": ("comedy", "daily"),
    "zUnEDRfx1k0": ("comedy", "daily"),
    "nD7Xc6HD_Pk": ("comedy", "daily"),
    "QjIRr5PL1rk": ("comedy", "daily"),
    "uvLxVACwkFs": ("comedy", "daily"),
    "no0HZ5eDdnY": ("work", "comedy"),
    "BSV-twtKV_g": ("work", "comedy"),
    "59bbhts01Q0": ("work", "comedy"),
    "oZn5LRn-giw": ("work", "comedy"),
    "aN78Tz_e5c4": ("kids",),
    "sN_vqwoC53Q": ("kids",),
    "EzZ5Abh8xTM": ("kids",),
    "xfc1j4rpw0c": ("kids",),
